function SpryMap (param) {
  ...
  m.hoverCursor = param.hoverCursor || 'auto'
  m.dragCursor = param.dragCursor || 'url(data:image/vnd.microsoft.iconbase64,), default'
  ...
  var MouseMove = function (b) {
    ...
    var d = b.clientY - m.mousePosition.y + parseInt(m.map.style.top)
    MoveMap(e, d)
